...
const Profile = (props) => {
                        ...
                        if (newArry) {
                            for(let i in newArry) {
                                ...
                                if(oneArry.wallet == wallet) {
                                    ...
                                    imageRef.current.src = oneArry.image ? oneArry.image : require('../../../assets/member/img/avatar.png').default
    ...
    useEffect(() => {
        ...
        setInitialSetting()
    }, [props.userInfo.wallet, props.userLoad, files.length, prevFiles.length]);
    ...
    const handleSubmit = async (e) => {
        ...
        let niftyRef = database.ref('member_profile')
                        ...
                        for(let i in newArry) {
                            ...
                            if(oneArry.wallet == wallet) {
                                ...
                                database.ref().update(updates).then(function(){
                                    ...
                                    setLoading(false)
                                    setTimeout(function () { window.location.href = 'project'; }, 3000);
                                }).catch(function(error) {
                                    window.scrollTo(0, 0)
                                    NotificationManager.error('The member profile submission failed.', 'Error', 3000)
                                    setLoading(false)
                                });
            ...
            if(!updateFlag) {
                ...
                newUserRef.set(load)  
                window.scrollTo(0, 0)
                NotificationManager.success('The member profile was successfully submitted.', 'Success', 3000)
                setLoading(false)
                setTimeout(function () { window.location.href = 'project'; }, 3000);
            }
    ...
    const reset = () => {
        ...
        imageRef.current.src = require('../../../assets/member/img/avatar.png').default
    ...
    return(
        <BlockUi tag="div" blocking={blocking} keepInView>
            <Container>
                ...
                <Row className="avatar">
                    ...
                    <p>
                        ...
                        <input className="input-image" id="input-image" accept="image/*" type="file" name="image" className="d-none" onChange={changeImage} />
                        <img ref={imageRef} src={require('../../../assets/member/img/avatar.png').default} onClick={handleImage}/>
                    </p>
                </Row>
                    ...
                    <Form onSubmit={handleSubmit} encType="multipart/form-data">
                        <Row>
                                ...
                                <Row>
                                    <Col lg="12" md="12" sm="12" className="sub-main-col">
                                        <Form.Group controlId="formHeld">
                                            <Form.Label>Nifty Passes Held</Form.Label>
                                            <Form.Control as="textarea" rows="5" disabled={true} placeholder="Nifty Passes Held" defaultValue={held} />
                                        </Form.Group>
                                    </Col>
                                </Row>
                            </Col>
                            <Col lg="12" md="12" className="main-col">
                                <Form.Group controlId="formHeld">
                                    <Form.Label style={{ wordBreak: 'break-word' }}>Expertise/Interest(check all that apply)</Form.Label>
                            ...
                            <Col lg="8" className="main-col decliamer-panel">
                                <Form.Group className="mb-4">
                                    ...
                                    <div className="footer-element file-panel">
                                        <input className="input-file" id="input-file" type="file" name="file" className="d-none" onChange={changeFile} multiple />
                                        <Button variant="light" className="file-upload-button" onClick={setFile}>
