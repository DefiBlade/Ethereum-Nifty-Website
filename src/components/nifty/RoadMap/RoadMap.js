...
import roadMapLogo from '../../../assets/nifty/img/roadmap/1.gif';
import bottomTransition from '../../../assets/nifty/img/roadmap/SectionTransition2 2.svg';
import mainBack from '../../../assets/nifty/img/roadmap/back1.png';
import platformBack from '../../../assets/nifty/img/roadmap/back2.png';
import platformSide from '../../../assets/nifty/img/roadmap/platform_side.png';
...
export const RoadMap = () => {
    const roadMapInfo = [
        ...
        {
            title: '75% Sold',
            content: 'Locked Set of Nodestones will be collected and airdropped to 1 lucky winner!',
        },
        {
            title: '100% Sold',
