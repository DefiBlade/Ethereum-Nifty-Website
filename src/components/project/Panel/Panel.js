...
const Panel = (props) => {
    ...
    useEffect( () => {
        console.log((props.proposal.files ? Object.values(props.proposal.files).shift() : ''))
        if(props.userLoad) {
                    ...
                    <div className="submit-project">
                        <div className="panel-title">
                            <span className="submit">
                                ...
                                <small><b>{props.proposal.creatorName ? props.proposal.creatorName : props.proposal.creator}</b></small>
                            </span>
                            <span className="price">
                                <span className="title-label">Price:&nbsp;</span>
                                <b><small>{props.proposal.price ? (props.proposal.price + ' ' + (prices[props.proposal.blockchain] ? prices[props.proposal.blockchain] : '')) : ''}</small></b>
                            </span>
                            <span className="supply">
                                <span className="title-label">Supply:&nbsp;</span>
                                <b><small>{props.proposal.supply}</small></b>
                            </span>
                        </div>
                        <Link to={`/project/project/${props.proposal.id}/${props.proposal.t}`}>
