    ...
    return (
        <Row className="project-avatar">
            ...
            <Col lg="2" md="4" sm="4" xs="12" className="avatar-container">
                <img ref={imageRef} src={props.userInfo.image ? props.userInfo.image : require('../../../assets/project/img/avatar.png').default} alt="User avatar" />
            </Col>
            <Col lg="5" md="12" sm="12" xs="12">
                <Row className="avatar-description">
                    ...
                    <Col lg="6" md="6" sm="6" xs="6" className="avatar-label"><p>Nifty Passes Held:</p></Col>
