...
import Post from '../../../components/project/Post/Post';
                    ...
                    <Row>
                        <Col lg={5} md={12} sm={12}>
                            ...
                            { (t == 1 && creator && props.userInfo && creator.wallet == props.userInfo.wallet) ? 
                                <Link to={"/project/proposal/" + id} className="btn btn-secondary btn-sm edit-proposal">Edit your proposal</Link>
                             : '' }
                             { (t == 2 && creator && props.userInfo && creator.wallet == props.userInfo.wallet) ? 
                                 <Link to={"/project/outside/" + id} className="btn btn-secondary btn-sm edit-proposal">Edit this project</Link>
                              : '' }
                            </p>
                            <div className="project-detail project-panel">
                                ...
                                <div className="project-condition">
                                    <div className="supply">Supply: <b>{ project ? project.supply : '' }</b></div>
                                    <div className="price">Price: <b>{ project ? (project.price ? (project.price + ' ' + (prices[project.blockchain] ? prices[project.blockchain] : '')) : '') : '' } </b></div>
                                    <div className="votes">Votes: <b>{voteCount}</b></div>
                                </div>
                                ...
                                <div className="project-upvote">
                                    {/* <Confirm
                                        ...
                                        <Button variant={'warning'} onClick={vote} disabled={voteState} onClick={vote}>Upvote this project &nbsp;
                        ...
                        <Col lg={7} md={12} sm={12}>
                            ...
                            <div className="project-avatar project-panel">
                                <div className="photo">
                                    <img src={creator.image ? creator.image : require('../../../assets/project/img/avatar.png').default} alt="Creator Avatar Image" />
                                </div>
                                <div className="detail">
                                    <Row>
                                        ...
                                        <Col lg="6" md="6" sm="6" xs="6" className="photo-label"><p>Nifty Passes Held : </p></Col>
