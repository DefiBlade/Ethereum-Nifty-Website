...
import Panel from '../../../components/project/Panel/Panel';
        ...
        <div className="home">
            ...
            <Container className="page-container">
                ...
                <Row>
                    <Col lg="6" md="6" sm="12">
                        <div className="requirement">
                            <div className="nifty-image">
                                <img src={require('../../../assets/project/img/niftyio.svg').default}/>
                            </div>
                            <h1>NFT Projects</h1>
                            <ul id="up-ul">
                                <li>
                    ...
                    <Col lg="6" md="6" sm="12">
                        <div className="idea">
                            <img src={require('../../../assets/project/img/idea.svg').default} className="idea-image" />
                        </div>
                        <div>
                            <ul id="down-ul">
                                <li>
