                    ...
                    if (newArry) {
                        for(let i in newArry) {
                            ...
                            if(oneArry.wallet == wallet) {
                                ...
                                imageRef.current.src = oneArry.image ? oneArry.image : require('../../../assets/project/img/avatar.png').default
            ...
            <Container className="profile">
                ...
                <Row className="avatar-profile">
                    ...
                    <p>
                        ...
                        <img ref={imageRef} src={require('../../../assets/project/img/avatar.png').default} onClick={handleImage}/>
                    </p>
                </Row>
                                ...
                                <Row>
                                    <Col lg="12" md="12" sm="12" className="sub-main-col">
                                        <Form.Group controlId="formHeld">
                                            ...
                                            <Form.Control as="textarea" rows="5" disabled={true} placeholder="Nifty Passes Held" value={held} />
                                        </Form.Group>
                                    </Col>
                                </Row>
                            </Col>
                            ...
                            <Col lg="12" className="main-col submit-button-panel">
                                <Form.Group className="mb-4">
                                    ...
                                    <div className="footer-element">
                                        <Link to="/project" className="back">&lt;&lt;-back to projects</Link>
