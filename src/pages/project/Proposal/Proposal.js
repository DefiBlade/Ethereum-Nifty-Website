...
import Avatar from '../../../components/project/Avatar/Avatar';
                        ...
                        <Form onSubmit={handleSubmit} encType="multipart/form-data">
                            <Row>
                                ...
                                <Col lg="12" md="12" sm="12" className="main-col interest-panel">
                                    <Form.Group className="mb-4">
                                        <Form.Label>Team Members<small> (check all that apply)</small></Form.Label>
                                ...
                                <Col lg="12" className="main-col padding-bottom-20">
                                    <Link to="/project" id="link">&lt;&lt;-back to projects</Link>
